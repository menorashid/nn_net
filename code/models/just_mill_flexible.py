...
class Network:
    def __init__(self, n_classes, deno, layer_sizes, init = False):
        model = Just_Mill(n_classes, deno,layer_sizes)
    ...
    def get_lr_list(self, lr):
        ...
        lr_list+= [{'params': self.model.features.parameters(), 'lr': lr[1]}]
