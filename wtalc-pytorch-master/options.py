...
parser.add_argument('--max-iter', type=int, default=10000, help='maximum iteration to train (default: 10000)')
parser.add_argument('--test_after', type=int, default=100, help='iterations to test after (default: 100)')
