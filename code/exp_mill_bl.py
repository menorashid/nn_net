...
def train_simple_mill(model_name, lr, dataset, deno, limit, epoch_stuff=[30,60],res=False, class_weights = False, batch_size = 32, batch_size_val = 32, save_after = 1, model_file = None, gpu_id = 0, exp = False, test_mode = False
    ,test_after = 1):
    ...
    strs_append_list = ['deno',deno,'limit',limit,'cw',class_weights, criterion_str, num_epochs]+dec_after+lr
...
def train_simple_mill_all_classes(model_name,
    ...
    strs_append_list = ['all_classes',all_classes,'deno',deno,'limit',limit,'cw',class_weights, criterion_str, num_epochs]+dec_after+lr
    strs_append = '_'.join([str(val) for val in strs_append_list])
